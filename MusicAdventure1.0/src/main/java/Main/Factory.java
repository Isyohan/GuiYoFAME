...
public class Factory implements EntityFactory {
    ...
    public Entity newBackground(SpawnData data) {
        return entityBuilder()
                .view(new ScrollingBackgroundView(texture("background/proj.png")))
                .zIndex(-1)
    ...
    public Entity newBackground2(SpawnData data) {
        return entityBuilder()
                .view(new ScrollingBackgroundView(texture("background/proj2.png")))
                .zIndex(-1)
                .with(new IrremovableComponent())
                .build();
    }
    ...
    public Entity newBackground3(SpawnData data) {
        return entityBuilder()
                .view(new ScrollingBackgroundView(texture("background/proj3.png")))
                .zIndex(-1)
                .with(new IrremovableComponent())
                .build();
    }
    ...
    public Entity newMessagePrompt(SpawnData data) {
        var text = getUIFactoryService().newText(data.get("message"), Color.YELLOW, FontType.GAME, 20.0);
    ...
    @Spawns("messageCode")
    public Entity newMessageCode(SpawnData data) {
        String message = data.get("message");

        KeyCode keyCode = KeyCode.getKeyCode(message);
